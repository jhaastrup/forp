(function ($) {
    ...
    $(document).ready(function () {
         ...
         */
        if (window.location.href.indexOf('?page=wc-settings&tab=shipping&section=wooss') > 0) {
            ...
            wooss_connect_btn.on('click',function(e){
                ...
                $.post(wooss_ajax_object.wooss_ajax_url,{
                    ...
                    if (1 == response){
                        $('<div id="message" class="updated inline"><p><strong>Your API key is valid, this page will be refreshed in 10s.</strong></p></div>').insertAfter('br.clear');     
                        setTimeout( reloadPage, 1000);    
                    }else if(0 == response){
                        wooss_errors_message_span.append('Invalid API key login to sendbox and get the correct key').show();
                    }
                });
            ...
            wooss_button_save.on('submit click', function (e) {
                ...
                $.post(wooss_ajax_object.wooss_ajax_url, {
                  ...
                  if (1 == response){
                    $('<div id="message" class="updated inline"><p><strong>Your settings have been synced.</strong></p></div>').insertAfter('br.clear');
                 } else{
                      alert("Sendbox Error !!!"); 
                  }
                });
